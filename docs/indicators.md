...
All point/count/distance evidence used by L indicators and KPIs must be filtered to this same context. For project boundaries, the stored project area supplies density denominators. Exact clipping of land-use and green/blue polygons at an irregular boundary remains open, so area-share indicators must retain the corresponding caveat.
